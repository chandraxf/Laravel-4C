            ...
            <div class="card-body">
                <form action="{{ route('update.mahasiswa', $mahasiswa->id) }}" method="POST" class="form-item" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="user" class="form-control col-md-12" placeholder="Masukan Nama" value="{{is_null($mahasiswa) ? '' : $mahasiswa->user }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat" class="form-control col-md-12" placeholder="Masukan Alamat" value="{{is_null($mahasiswa) ? '' : $mahasiswa->alamat }}">
                    </div>
                    <h6>Jenis Kelamin</h6>
